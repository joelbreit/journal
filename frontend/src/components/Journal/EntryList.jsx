...
export function EntryList() {
	...
	useEffect(() => {
		console.log("[DEBUG] useEffect: EntryList load entries");
		loadEntries();
	}, []);
		...
		return (
			<div className="bg-rose-50 border border-rose-200 rounded-xl p-6 text-center">
				...
				<Button
					variant="secondary"
					onClick={() => {
						console.log("[DEBUG] onClick: Try Again button");
						loadEntries();
					}}
				>
					Try Again
		...
		return (
			<div className="text-center py-12">
				...
				<Button
					...
					onClick={() => {
						console.log(
							"[DEBUG] onClick: Create First Entry button"
						);
						debugNavigate("/entry/new");
					}}
				>
					Create First Entry
				</Button>
